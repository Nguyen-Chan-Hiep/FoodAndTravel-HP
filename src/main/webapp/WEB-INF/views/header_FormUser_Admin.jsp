							...
							<div class="widget-content-left">
								<div class="btn-group">
									<a data-toggle="dropdown" aria-haspopup="true"
										...
										class="rounded-circle" src="assets/images/_default-user.png"
												...
												<div class="menu-header-content text-left">
													<div class="widget-content p-0">
														<div class="widget-content-wrapper">
															...
															<div class="widget-content-left">
																<div class="widget-heading">${user.getUsername() }</div>
																<div class="widget-subheading opacity-8">Mô tả hồ
																	sơ ngắn</div>
															</div>
											...
											<div class="scrollbar-container ps">
												<ul class="nav flex-column">
													...
													<li class="nav-item"><a href="javascript:void(0);"
														class="nav-link">Tin nhắn
															<div class="ml-auto badge badge-pill badge-info">8</div>
													</a></li>
													<li class="nav-item"><a href="javascript:void(0);"
														class="nav-link">Khôi phục mật khẩu</a></li>
